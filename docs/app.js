...
if(Array.isArray(window.KOJISHO_DATA)&&window.KOJISHO_DATA.length){start(window.KOJISHO_DATA)}else{ui.loading.style.display='none';ui.error.hidden=false;ui.error.querySelector('strong').textContent='辞書データを読み込めません'}
